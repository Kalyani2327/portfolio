...
const techStack = [
  ...
  },
  {
    ...
    langName: "SQL",
    langDesc: "<li>SQL (Structured Query Language) is a standard programming language used to manage and manipulate relational databases, allowing users to store, retrieve, update, and delete data efficiently.</li>",
  },
  {
